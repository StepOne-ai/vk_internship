...
// 	log := logger.With(logger.Field{Key: "component", Value: "grpc-server"}) // Исправлено создание Field
...
// 	pb.RegisterPubSubServer(server, NewPubSubServer(sp, log)) // Исправлено имя
